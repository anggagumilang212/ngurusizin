import LoadingTentang from "@/components/elements/LoadingTentang";
...
export default function Tentang() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://89.116.187.91:5000/api/tentang");
  ...
  return (
    <>
      {[Tentang[0]].map((item, index) => (
        <div className="py-16 bg-white lg:px-28" key={item.id}>
            ...
            <div className="w-full draggable">
              <div className="container flex flex-col items-center gap-16 mx-auto my-32">
                <div className="grid w-full grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                  <div className="flex flex-col items-center gap-3 px-8 py-10 bg-white shadow-2xl rounded-3xl">
                    <span>
                      <svg

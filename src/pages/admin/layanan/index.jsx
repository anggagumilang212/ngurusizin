...
export default function Layanan() {
  ...
  return (
    <>
      <AdminLayout>
        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8 -mt-40">
            ...
            <div class="flex justify-between">
              <div class="inline-flex border rounded w-7/12 px-2 lg:px-6 h-12 bg-transparent">
                <div class="flex flex-wrap items-stretch w-full h-full mb-6 relative">
                  ...
                  <input
                    type="text"
                    class="flex-shrink flex-grow flex-auto leading-normal tracking-wide w-px flex-1 border border-none border-l-0 rounded rounded-l-none px-3 relative focus:outline-none text-xxs lg:text-xs  text-gray-500 font-thin"
                    placeholder="Search"
                  />
                </div>
              </div>
            ...
            <table class="min-w-full">
              <thead>
                <tr>
                  ...
                  <th class="py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">
                    deskripsi
                  </th>
